...
const CONFIG = {
    ...
    textos: {
        ...
        cat3: { t: "TESTIMONIOS EN VIDEO E IMAGEN", c: "Excelente atención. Me curaron una uña encarnada sin dolor y la recuperación fue rapidísima. ¡Super recomendados!. Carlos Chavéz" }
    }
};
let currentGallery = [];
let currentIndex = 0;
